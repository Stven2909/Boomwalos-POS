...
class DemoUsersSeeder extends Seeder
{
    public function run(): void
    {
        $admin = $this->firstOrCreateUser(
            email: $this->requiredEnv('BOOMWALOS_ADMIN_EMAIL'),
            username: 'admin',
            name: 'Administrador General',
            password: $this->requiredEnv('BOOMWALOS_ADMIN_PASSWORD'),
        );
        $admin->syncRoles('administrador');

        $cashier = $this->firstOrCreateUser(
            email: $this->requiredEnv('BOOMWALOS_CASHIER_EMAIL'),
            username: $this->requiredEnv('BOOMWALOS_CASHIER_CODE'),
            name: 'Lucía García',
            password: $this->requiredEnv('BOOMWALOS_CASHIER_PIN'),
        );
